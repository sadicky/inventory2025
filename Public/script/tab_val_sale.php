...
<div class="card" style="margin:30px;">
    <div class="card-header text-center">
        <h3>Valorisation des ventes Du <?php echo $from_d; ?> Au <?php echo $to_d; ?></h3>
    </div>
    <div class="card-body card-block">
        <form id="form_srch_rpt_val" method="post" action="javascript:void(0)">
            <div class="form-body">
                <div class="form-row">
                    <div class="col-md-2">
        ...
        <?php if (!empty($_GET['id'])) : ?>
            <div class="table-responsive">
                <table class="table table-bordered table-sm display tab">
                    ...
                    <tbody>
                        <?php
                        $datas = $transactions->select_all_period_bq_0($bqId, $from_d, $to_d);
                        $solde = 0;
                        $tot_in = 0;
                        $tot_out = 0;
                        $open = 0;
                        ...
                        echo '<tr><th>Valorisation de produits vendus</th><th>-</th><th>-</th><th align="right" style="color:red">' . $tot_in . '~=(' . number_format($tot_in, 2, ',', ' ') . ')</th></tr>';
                        ?>
                    </tbody>
                </table>
            </div>
