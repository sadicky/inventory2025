...
<div class="card">
	<div class="card-header bg-light">Historique des Dettes</div>
	<div class="card-body">
		<form method="post" id="dette-search">
			<div class="row">
				<div class="col-md-2">
		...
		<?php if (!empty($_GET['pos_id'])) : ?>
			...
			<div class="table-responsive">
				<table class="table table-bordered table-sm tab">
					...
					<tbody>
						<?php
						$datas = $operations->select_all_by_period_dette('Vente', $from_d, $to_d, $posId);
					...
					<tfoot>
						<tr>
							<th>Total</th>
							<th colspan="2" style="text-align: right"><?php echo number_format($totM, 0, ',', ' ');
																		?></th>
