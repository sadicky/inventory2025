...
<div id="facture<?php echo $un['op_id']; ?>" class="card" style="width: 200mm;
          height: 287mm;
          margin: 0;
          padding: 0;
    ...
    <div class="card-header bg-light" style="float: left;margin-left:20px">
        ...
        <span> <img src="assets/img/costic/costic-logo-216x62.png" width="150px" alt="logo"></span>
        <?php
        echo $cfg['rpt_header'];
        ?>
    ...
    // $info->select($vente2->idvente);
    // $cust->select($pers->getPersonneId());
    // $cust2->select($op->getAffId());
    ?>
    <div class="card-body">
        <div class="table-responsive">

            <table class="table table-bordered table-striped table-condensed" border="1" width="100%" style="font-size: 10px;">
                <thead>
                    <tr>
                        <th>Produit</th>
                        <th>Qté</th>
                ...
                <tbody>
                    ...
                    if (isset($un['op_id'])) {
                        ...
                        foreach ($datas2 as $val) {
                            ...
                            echo '<tr><td >' . $prod->product_name . '</td><td align="right">' . $val['quantity'] . '</td><td align="right">' . number_format($val['amount'], 0, ',', ' ') . ' FC</td><td align="right">' . number_format($pt, 0, ',', ' ') . '</td></tr>';
                        }
                        echo '</tbody><tfoot>';
