...
<div class="col-md-12">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb pl-0">
      ...
      <li class="breadcrumb-item"><a href="#">Tous les produits</a></li>
    </ol>
  </nav>
          ...
          <div class="table-responsive">
            ...
            if (!empty($_GET['cat_id'])) {
              if ($_GET['cat_id'] == 'Tous') {
                ...
                //   $dat = $products->select_all_cat($_GET['cat_id']);
                $d =  $categories->getCategoryId($_GET['cat_id']);
                echo '<h3>Catégorie : ' . $d->category_name . '</h3>';
              }
            } else {
              $datas = $products->select_all_date(date('Y-m-d'));
              echo '<h3>Dernièrs enregistrements</h3>';
            }

            echo '<input value=" " type="hidden" name="table_name" id="tab_details" data-id="prod_id">';
            ?>
