                ...
                <div class="form-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" id="search_products" name="content_lib_art" class="form-control" value="<?php if (!empty($_GET['id'])) echo $pers->getNomComplet(); ?>" autocomplete="off" required>
