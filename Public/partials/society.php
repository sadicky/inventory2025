...
?>
<div class="ms-panel" style="margin:25px; margin-bottom:50px;">
    <h3 class="ms-panel-header bg-light">Identitication de la société</h3>
    ...
    <div class="ms-panel-body">
        ...
        <!-- <form id="frm_interconnect" method="post">
            <div class="form-body">
                <div class="form-row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="control-label">URL</label>
                            <input type="text" id="con_url" name="con_url" class="form-control" value="<?php echo $in['con_url'];?>" >
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label class="control-label">Username</label>
                            <input type="text" id="con_username" name="con_username" class="form-control" value="<?php echo $in['con_username'];?>" >
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label class="control-label">Mot de passe</label>
                            <input type="text" id="con_password" name="con_password" class="form-control" value="<?php echo $in['con_password'];?>" >
                        </div>
                    </div>
