            ...
            <div class="row">
                <div class="col-sm-3"><!--left col-->
                    ...
                    <ul class="list-group">
                            ...
                            <?php if($_SESSION['role']==1):?><li class="list-group-item text-right"><button class="btn btn-danger btn-sm trash_stk"><i class="fa fa-times-circle"></i> Supprimer</button></li><?php   endif?>
                  </ul>
