    ...
    <div class="container-fluid">
        <div class="row" style="background-color: gainsboro;">
            ...
            <div class="col-md-4" style="text-align: center;margin-bottom:5px;">
                <a href="javascript:void(0)" id="pos-cash" class="btn btn-info btn-sm">CASH</a>
                <a href="javascript:void(0)" id="pos-dette" class="btn btn-danger btn-sm">DETTE</a>
                <a href="javascript:void(0)" id="pos-proformat" class="btn btn-warning btn-sm">PROFORMAT</a>
        ...
        <div class="container-fluid row" style="margin-top:0px;">
            ...
            <?php if (isset($_SESSION['jour'])) {  ?>
                ...
                <div>
                    ...
                    <div class="col-md-12 mt-2" id="page-content-res" style="font-size: 13px;"> </div>
